...
const jwtAuth_guard_1 = __webpack_require__("./src/authentication/jwtAuth.guard.ts");
const roles_decorator_1 = __webpack_require__("./src/roles/roles.decorator.ts");
const roles_guard_1 = __webpack_require__("./src/roles/roles.guard.ts");
const flowda_shared_1 = __webpack_require__("../../../libs/flowda-shared/src/index.ts");
let AppController = class AppController {
    constructor(schemaService, appService, appAuth, customerService, orderService) {
    ...
    query(req, query) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { start, end, id, appId, email, name } = query;
            const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
            // return this.customerService.findbyAppId(appId);
            const queryData = {
                tenantId: userId,
            };
            if (start) {
                queryData.createdAt = {
                    gte: new Date(Number(start)) /* Includes time offset for UTC */,
                };
            }
            if (end) {
                queryData.updatedAt = {
                    lte: new Date(Number(end)) /* Includes time offset for UTC */,
                };
            }
            if (id) {
                queryData.id = id;
            ...
            return this.customerService.findAll(queryData);
        });
    }
    create1(dto) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    queryOrder(req, query) {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
            // return this.customerService.findbyAppId(appId);
            const { start, end, id, serial, status, customerId } = query;
            ...
            if (serial) {
                queryData.serial = Number(serial);
            }
            if (status) {
                queryData.status = status;
            }
            if (customerId) {
                queryData.customerId = customerId;
            }
    ...
    getStats(req) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!tenantId) {
                throw new v1_flowda_types_1.AuthenticationError.InvalidTenant();
            }
            // Order count
            // Customer count
            const LastDayLong = 24 * 3600 * 1000;
            const LastWeekLong = 7 * LastDayLong;
            const dayStart = Date.now() - LastDayLong;
            const weekStart = Date.now() - LastWeekLong;
            const queryDataByDay = {
                tenantId,
            };
            queryDataByDay.createdAt = {
                gte: new Date(Number(dayStart)),
            };
            const queryDataByWeek = {
                tenantId,
            };
            queryDataByWeek.createdAt = {
                gte: new Date(Number(weekStart)),
            };
            const customerDayResp = yield this.customerService.count(queryDataByDay);
            const customerWeekResp = yield this.customerService.count(queryDataByWeek);
            const orderDayResp = yield this.orderService.count(queryDataByDay);
            const orderWeekResp = yield this.orderService.count(queryDataByWeek);
            return {
                customer: {
                    day: customerDayResp,
                    week: customerWeekResp,
                },
                order: {
                    day: orderDayResp,
                    week: orderWeekResp,
    ...
    findByTenantId(req) {
        const user = req.user;
        return this.appService.findByTenantId(user.id);
    }
    findByTenantId2(req) {
        const user = req.user;
        return this.appService.findByTenantId('cljuorok20001rps5h96edaf7');
    }
    findById(id) {
    ...
    create(req, dto) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return this.appAuth.create(Object.assign(Object.assign({}, dto), { tenantId }));
        });
    }
    superQueryApps() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_f = typeof v1_flowda_services_1.AppCreateDto !== "undefined" && v1_flowda_services_1.AppCreateDto) === "function" ? _f : Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AppController.prototype, "create1", null);
tslib_1.__decorate([
    (0, common_2.UseGuards)(jwtAuth_guard_1.JwtAuthGuard),
    (0, common_2.Get)('orders'),
    tslib_1.__param(0, (0, common_2.Req)()),
    tslib_1.__param(1, (0, common_2.Query)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AppController.prototype, "queryOrder", null);
tslib_1.__decorate([
    (0, common_2.UseGuards)(jwtAuth_guard_1.JwtAuthGuard),
    (0, common_2.Get)('stats'),
    tslib_1.__param(0, (0, common_2.Req)()),
    tslib_1.__metadata("design:type", Function),
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", void 0)
], AppController.prototype, "findByTenantId", null);
tslib_1.__decorate([
    (0, common_2.Get)('/temp'),
    tslib_1.__param(0, (0, common_2.Req)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", void 0)
], AppController.prototype, "findByTenantId2", null);
tslib_1.__decorate([
    (0, common_2.UseGuards)(jwtAuth_guard_1.JwtAuthGuard),
    (0, common_2.Get)('/:id'),
...
tslib_1.__decorate([
    (0, common_2.Get)('/:id/temp'),
    tslib_1.__param(0, (0, common_2.Param)('id')),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", void 0)
], AppController.prototype, "findById2", null);
tslib_1.__decorate([
    (0, common_2.UseGuards)(jwtAuth_guard_1.JwtAuthGuard),
...
tslib_1.__decorate([
    ...
    (0, common_2.Get)('super/apps'),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", []),
    tslib_1.__metadata("design:returntype", Promise)
], AppController.prototype, "superQueryApps", null);
tslib_1.__decorate([
    (0, common_2.UseGuards)(jwtAuth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('superadmin'),
    (0, common_2.Get)('super/customers'),
    tslib_1.__param(0, (0, common_2.Query)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AppController.prototype, "superQueryCustomers", null);
tslib_1.__decorate([
    (0, common_2.UseGuards)(jwtAuth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('superadmin'),
    (0, common_2.Get)('super/orders'),
    tslib_1.__param(0, (0, common_2.Query)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AppController.prototype, "superQueryOrders", null);
exports.AppController = AppController = tslib_1.__decorate([
    (0, common_2.Controller)('/apps'),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof flowda_shared_1.SchemaService !== "undefined" && flowda_shared_1.SchemaService) === "function" ? _a : Object, typeof (_b = typeof v1_flowda_services_1.AppService !== "undefined" && v1_flowda_services_1.AppService) === "function" ? _b : Object, typeof (_c = typeof v1_flowda_services_1.AppAuthService !== "undefined" && v1_flowda_services_1.AppAuthService) === "function" ? _c : Object, typeof (_d = typeof v1_flowda_services_1.CustomerService !== "undefined" && v1_flowda_services_1.CustomerService) === "function" ? _d : Object, typeof (_e = typeof v1_flowda_services_1.OrderQuery !== "undefined" && v1_flowda_services_1.OrderQuery) === "function" ? _e : Object])
], AppController);
...
const authentication_controller_1 = __webpack_require__("./src/authentication/authentication.controller.ts");
const services_module_1 = __webpack_require__("./src/services/services.module.ts");
const local_strategy_1 = __webpack_require__("./src/authentication/local.strategy.ts");
const localApi_strategy_1 = __webpack_require__("./src/authentication/localApi.strategy.ts");
const jwt_strategy_1 = __webpack_require__("./src/authentication/jwt.strategy.ts");
const v1_flowda_services_1 = __webpack_require__("../../../libs/v1/flowda-services/src/index.ts");
const core_1 = __webpack_require__("@nestjs/core");
const product_controller_1 = __webpack_require__("./src/app/product.controller.ts");
const superAdmin_controller_1 = __webpack_require__("./src/authentication/superAdmin.controller.ts");
...
exports.appModuleProviders = [
    ...
    localApi_strategy_1.LocalApiStrategy,
...
let ProductController = class ProductController {
    constructor(query, productTx) {
        this.query = query;
        this.productTx = productTx;
    }
    findAll(appId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return this.query.findAll(appId);
        });
    }
    createMany(appId, dto) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const products = yield this.productTx.createManyProducts(appId, dto);
            return {
                products,
            };
        });
...
tslib_1.__decorate([
    (0, common_1.Get)(''),
    tslib_1.__param(0, (0, common_1.Param)('appId')),
    tslib_1.__metadata("design:type", Function),
...
exports.ProductController = ProductController = tslib_1.__decorate([
    (0, common_1.Controller)('apps/:appId/products'),
...
const common_1 = __webpack_require__("@nestjs/common");
const v1_flowda_services_1 = __webpack_require__("../../../libs/v1/flowda-services/src/index.ts");
const localAuth_guard_1 = __webpack_require__("./src/authentication/localAuth.guard.ts");
const localApiAuth_guard_1 = __webpack_require__("./src/authentication/localApiAuth.guard.ts");
const jwtAuth_guard_1 = __webpack_require__("./src/authentication/jwtAuth.guard.ts");
let AuthenticationController = class AuthenticationController {
     ...
     */
    preSignup(dto) {
        console.log('pre sign up: ', dto);
        return this.service.preSignup({
            email: dto.email,
        });
    }
    signup(dto) {
        const rt = this.service.verifyAndSignup(dto);
        return rt;
    }
    logIn(request) {
    ...
    logOut(request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const cookie = yield this.service.logout(request.user.id);
            request.res.setHeader('Set-Cookie', cookie);
        });
    }
    logOutApi(request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.service.logoutApi(request.user.id);
    ...
    /**
     * 和 /logIn 的区别是给 api 使用，由 client 自己决定如何存储
     */
    logInApi(req) {
        return req.user;
    }
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AuthenticationController.prototype, "query", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", void 0)
], AuthenticationController.prototype, "preSignup", null);
tslib_1.__decorate([
    (0, common_1.Post)('signup'),
    tslib_1.__param(0, (0, common_1.Body)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_b = typeof v1_flowda_services_1.TenantEmailSignupDto !== "undefined" && v1_flowda_services_1.TenantEmailSignupDto) === "function" ? _b : Object]),
    tslib_1.__metadata("design:returntype", void 0)
...
tslib_1.__decorate([
    (0, common_1.UseGuards)(jwtAuth_guard_1.JwtAuthGuard),
    (0, common_1.Post)('logOutApi'),
    (0, common_1.HttpCode)(200),
    tslib_1.__param(0, (0, common_1.Req)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AuthenticationController.prototype, "logOutApi", null);
tslib_1.__decorate([
...
tslib_1.__decorate([
    (0, common_1.UseGuards)(localApiAuth_guard_1.LocalApiAuthGuard),
    (0, common_1.Post)('logInApi'),
    (0, common_1.HttpCode)(200),
    tslib_1.__param(0, (0, common_1.Req)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", void 0)
], AuthenticationController.prototype, "logInApi", null);
exports.AuthenticationController = AuthenticationController = tslib_1.__decorate([
    (0, common_1.Controller)('auth'),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof v1_flowda_services_1.TenantAuthService !== "undefined" && v1_flowda_services_1.TenantAuthService) === "function" ? _a : Object])
...
/***/ "./src/authentication/jwtAuth.guard.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
let LocalStrategy = class LocalStrategy extends (0, passport_1.PassportStrategy)(passport_local_1.Strategy, 'local') {
    ...
    validate(username, password) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const user = yield this.authService.validateUser('name', username, password);
            if (!user) {
                throw new common_1.UnauthorizedException();
            }
            // 返回 user，cookie 在 controller 里设置
            return user; // user 会附着到 request
        });
    }
};
...
/***/ "./src/authentication/localApi.strategy.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.LocalApiStrategy = void 0;
const tslib_1 = __webpack_require__("tslib");
const passport_1 = __webpack_require__("@nestjs/passport");
const passport_local_1 = __webpack_require__("passport-local");
const common_1 = __webpack_require__("@nestjs/common");
const v1_flowda_services_1 = __webpack_require__("../../../libs/v1/flowda-services/src/index.ts");
let LocalApiStrategy = class LocalApiStrategy extends (0, passport_1.PassportStrategy)(passport_local_1.Strategy, 'localApi') {
    constructor(authService) {
        super();
        this.authService = authService;
    }
    ...
    validate(name, password) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const tokens = yield this.authService.validateUserReturnTokens('name', name, password);
            if (!tokens) {
                throw new common_1.UnauthorizedException();
            }
...
exports.LocalApiStrategy = LocalApiStrategy;
exports.LocalApiStrategy = LocalApiStrategy = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof v1_flowda_services_1.TenantAuthService !== "undefined" && v1_flowda_services_1.TenantAuthService) === "function" ? _a : Object])
], LocalApiStrategy);
...
/***/ "./src/authentication/localApiAuth.guard.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.LocalApiAuthGuard = void 0;
const tslib_1 = __webpack_require__("tslib");
const passport_1 = __webpack_require__("@nestjs/passport");
const common_1 = __webpack_require__("@nestjs/common");
let LocalApiAuthGuard = class LocalApiAuthGuard extends (0, passport_1.AuthGuard)('localApi') {
};
exports.LocalApiAuthGuard = LocalApiAuthGuard;
exports.LocalApiAuthGuard = LocalApiAuthGuard = tslib_1.__decorate([
    (0, common_1.Injectable)()
], LocalApiAuthGuard);
...
/***/ "./src/authentication/localAuth.guard.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./src/authentication/superAdmin.controller.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const roles_decorator_1 = __webpack_require__("./src/roles/roles.decorator.ts");
const roles_guard_1 = __webpack_require__("./src/roles/roles.guard.ts");
// todo: 增加 guard，比如在 env 里配置一串随机 key
let SuperAdminController = class SuperAdminController {
    constructor(tx, query) {
        this.tx = tx;
        this.query = query;
    }
    signup(dto) {
        const rt = this.tx.signup(dto);
        return rt;
    }
    getTenantList() {
        const rt = this.query.getTenantList();
        return rt;
    }
};
...
tslib_1.__decorate([
    ...
    tslib_1.__param(0, (0, common_1.Body)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_c = typeof v1_flowda_services_1.SupperAdminSignupDto !== "undefined" && v1_flowda_services_1.SupperAdminSignupDto) === "function" ? _c : Object]),
    tslib_1.__metadata("design:returntype", void 0)
], SuperAdminController.prototype, "signup", null);
tslib_1.__decorate([
    (0, common_1.UseGuards)(jwtAuth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('superadmin'),
    (0, common_1.Get)('getTenantList'),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", []),
    tslib_1.__metadata("design:returntype", void 0)
], SuperAdminController.prototype, "getTenantList", null);
exports.SuperAdminController = SuperAdminController = tslib_1.__decorate([
    (0, common_1.Controller)('/superadmin'),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof v1_flowda_services_1.SuperAdminAuthenticationTx !== "undefined" && v1_flowda_services_1.SuperAdminAuthenticationTx) === "function" ? _a : Object, typeof (_b = typeof v1_flowda_services_1.SuperAdminAuthenticationQuery !== "undefined" && v1_flowda_services_1.SuperAdminAuthenticationQuery) === "function" ? _b : Object])
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Roles = exports.RolesSymbol = void 0;
const common_1 = __webpack_require__("@nestjs/common");
exports.RolesSymbol = Symbol();
const Roles = (...requirements) => (0, common_1.SetMetadata)(exports.RolesSymbol, requirements);
exports.Roles = Roles;
...
let RolesGuard = class RolesGuard {
    constructor(reflector, query) {
        this.reflector = reflector;
        this.query = query;
    }
    canActivate(context) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const rolesArgs = this.reflector.get(roles_decorator_1.RolesSymbol, context.getHandler()) || [];
            if (rolesArgs.length === 0) {
                throw new Error('Roles decorator is need');
            }
            const request = context.switchToHttp().getRequest();
            const user = request.user;
            return this.query.mathRoles(rolesArgs, user);
        });
    }
};
...
exports.RolesGuard = RolesGuard = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof core_1.Reflector !== "undefined" && core_1.Reflector) === "function" ? _a : Object, typeof (_b = typeof v1_flowda_services_1.SuperAdminAuthenticationQuery !== "undefined" && v1_flowda_services_1.SuperAdminAuthenticationQuery) === "function" ? _b : Object])
], RolesGuard);
